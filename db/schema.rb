...
ActiveRecord::Schema[7.2].define(version: 2026_07_11_115411) do
  ...
  create_table "dmt_transactions", force: :cascade do |t|
    ...
    t.string "tid"
    t.decimal "tds", precision: 10, scale: 2, default: "0.0"
    t.decimal "service_tax", precision: 10, scale: 2, default: "0.0"
