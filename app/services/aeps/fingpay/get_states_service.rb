...
module Aeps
  module Fingpay
    class GetStatesService
      ...
      def call
        Rails.logger.info "================ EKO GET STATES START ================"
        Rails.logger.info "URL: #{self.class.base_uri}/ekoicici/v1/aeps/get-states"
        Rails.logger.info "Query: #{query_params.inspect}"
        Rails.logger.info "Headers: #{safe_headers.inspect}"

        response = self.class.get(
          "/ekoicici/v1/aeps/get-states",
          query: query_params,
          headers: headers
        )
        ...
        Rails.logger.info "================ EKO GET STATES END =================="
        ...
        Rails.logger.error "EKO GET STATES ERROR: #{e.message}"
