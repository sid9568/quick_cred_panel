...
module EkoDmt
  class ListRecipientsService
    ...
    # https://api.eko.in:25002/ekoicici/v3/customer/payment/dmt-fino/sender
    ...
    def self.call(
     ...
     p secret_key
      ...
      url = "#{BASE_URL}/#{sender_mobile}/recipients"
      ...
      # ================= LOG REQUEST =================
      Rails.logger.info "===== EKO LIST RECIPIENTS REQUEST ====="
      ...
      # ================= LOG RESPONSE =================
      Rails.logger.info "===== EKO LIST RECIPIENTS RESPONSE ====="
      ...
      Rails.logger.error "===== EKO LIST RECIPIENTS ERROR ====="
